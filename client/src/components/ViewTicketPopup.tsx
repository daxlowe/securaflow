          ...
          <CardContent>
            ...
            <Select name="team" disabled>
              <SelectTrigger>
                <SelectValue
                  placeholder={
                    task?.ticket.team ?? "No Team Currently Assigned"
                  }
                />
              </SelectTrigger>
            ...
            <Input
              type="text"
              id="assignees"
              value={task?.ticket.assignees?.toString() ?? "No Assignees"}
              disabled
            />
            ...
            <Input
              type="number"
              id="timeEstimate"
              value={task?.ticket.time_estimate ?? "No Time Estimate"}
              disabled
            />
            ...
            <Textarea
              id="comments"
              value={task?.ticket.comments ?? "No comments"}
              disabled
            />
          </CardContent>
        </ScrollArea>
